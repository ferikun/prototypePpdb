        ...
        <header>
            ...
            <div id="nav_admin">
                <ul class="nav" id="head_menu">
                    <li class="me-4">
                        <a href="#"><i class="fa-solid fa-user-pen me-2"></i>Ubah Profil</a>
                    </li>
                    <li class="me-4">
                        <a href="#"><i class="fa-solid fa-key me-2"></i>Ubah Password</a>
                    </li>
                    <li class="me-4">
                        <a href="#"><i class="fa-solid fa-circle-question me-2"></i>Help</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar" id="sideNavigation">
            ...
            <ul class="menu">
                ...
                <li><a href="#" class="btn1 sideMenu"><i class="fa-solid fa-address-card"></i>Pendaftaran<span class="fa-solid fa-caret-down ms-4 satu"></span></a>
                    <ul class="show-satu">
                        <li><a href="/daftar-siswa" class="ms-3 subMenu"><i class="fa-solid fa-right-from-bracket"></i>Calon Siswa</a></li>
                ...
                <li>
                    <a href="#" class="mb-5 sideMenu"><i class="bi bi-box-arrow-left"></i>Keluar</a>
                </li>
            </ul>
        </div>
        <!-- Akhir Sidebar -->
